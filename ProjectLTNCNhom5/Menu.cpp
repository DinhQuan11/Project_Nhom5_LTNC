...
void menuAdmin()
{
	...
	cout << setw(18) << "4. " << "Cap nhat thong tin Nhan vien" << endl;
	cout << setw(18) << "5. " << "Hien thi toan bo Nhan vien" << endl;
...
void addEmployee(User* user)
{
	...
	else
	{
		...
		outFile << empl->getName() << endl << empl->getDateOfbirth() << endl
			<< empl->getSalary() << endl << empl->getEmail();
		outFile.close();
...
void searchEmployee(User* user, string strUserName)
{
	...
	cout << setw(25) << left << user->getDateOfbirth();
	cout << setw(15) << left << user->getSalary();
...
void updateEmployee(User* user)
{
	...
	if (isUsernameEmployee(user, strUserName))
	{
		...
		cout << setw(18) << "" << "2. Ngay sinh" << endl;
		cout << setw(18) << "" << "3. Luong" << endl;
		...
		case 1:
		{
			...
			outFile.open("Temp.txt", ios_base::out); // Tạo file Temp.txt
			outFile << strEdit << endl << user->getDateOfbirth() << endl << user->getSalary()
			...
			outFile << user->getName() << endl << user->getDateOfbirth() << endl
				<< user->getSalary() << endl << user->getEmail();
			inFile.close();
			outFile.close();
			delete user;
		...
		case 2:
		{
			system("cls"); // Clear màn hình console
			setColor(0, 13);
			cout << endl << setw(18) << "" << "~~~ Cap nhat ngay sinh ~~~" << endl;
			setColor(0, 11);
			cout << endl << setw(18) << "" << "Nhap ngay sinh muon thay doi:" << endl;
			cout << setw(18) << " -> ";
			...
			outFile.open("Temp.txt", ios_base::out); // Tạo file Temp.txt
			outFile << user->getName() << endl << strEdit << endl << user->getSalary()
				<< endl << user->getEmail(); // Nhập thông tin mới vào file Temp.txt
			inFile.close();
			outFile.close();
			user->deleteFile(strUserName); // Xóa file thông tin Employee cũ
			...
			setColor(0, 10);
			cout << endl << setw(18) << " (!) " << "Cap nhat ngay sinh Nhan vien thanh cong!" << endl;
			remove("Temp.txt"); // Xóa file Temp.txt
			break;
		}
		case 3:
		{
			system("cls"); // Clear màn hình console
			setColor(0, 13);
			cout << endl << setw(18) << "" << "~~~ Cap nhat luong ~~~" << endl;
			setColor(0, 11);
			cout << endl << setw(18) << "" << "Nhap luong muon thay doi:" << endl;
			cout << setw(18) << " -> ";
			...
			outFile.open("Temp.txt", ios_base::out); // Tạo file Temp.txt
			outFile << user->getName() << endl << user->getDateOfbirth() << endl << strEdit
				<< endl << user->getEmail(); // Nhập thông tin mới vào file Temp.txt
			inFile.close();
			outFile.close();
			user->deleteFile(strUserName); // Xóa file thông tin Employee cũ
			...
			setColor(0, 10);
			cout << endl << setw(18) << " (!) " << "Cap nhat luong Nhan vien thanh cong!" << endl;
			remove("Temp.txt"); // Xóa file Temp.txt
			break;
		}
		case 4:
		{
			...
			outFile.open("Temp.txt", ios_base::out); // Tạo file Temp.txt
			outFile << user->getName() << endl << user->getDateOfbirth() << endl << user->getSalary()
...
void showAllEmployee(User* user)
{
	...
	setColor(0, 13);
	cout << endl << setw(18) << "" << "~~~~~ Hien thi tat ca Nhan vien ~~~~~" << endl;
	setColor(0, 11);
		...
		if (isLoginSuccess(user, "Administrators.txt", strAcc, strPass))
		{
			...
			while (true)
			{
				...
				case 2:
				{
					...
					setColor(0, 9);
					cout << setw(18) << "" << "Nhap Username Nhan vien muon xoa:" << endl;
					cout << setw(18) << " -> ";
				...
				case 3:
				{
					...
					setColor(0, 9);
					cout << setw(18) << "" << "Nhap Username Nhan vien muon tim:" << endl;
					cout << setw(18) << " -> ";
